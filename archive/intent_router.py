...
class IntentRouter:
    ...
    def _load_parameter_llm(self):
        ...
        try:
            ...
            print("✅ Phase 1 Parameter Collection LLM loaded")
        except ImportError as e:
            print(f"⚠️ Phase 1 Parameter LLM not available: {e}")
    ...
    def _load_analysis_llm(self):
        ...
        try:
            ...
            if hasattr(llm_calls, 'query_intro') and hasattr(llm_calls, 'suggest_improvements'):
                ...
                print("✅ Phase 2 Analysis LLM loaded")
            else:
                self.analysis_llm_available = False
                print("⚠️ Phase 2 Analysis functions not found")
        except ImportError as e:
            print(f"⚠️ Phase 2 Analysis LLM not available: {e}")
            self.analysis_llm_available = False
    ...
    def _process_phase1(self, user_input):
        ...
        try:
            ...
            if new_state == "complete":
                response += "\n\n🎯 Phase 1 complete! You can now ask for design analysis, improvements, or changes."
